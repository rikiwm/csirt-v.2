...
<body>
    ...
    <p>{{ $details['body']['priority'] }}</p>
    <p>{{ $details['body']['code'] }}</p>
    <p>{{ $details['body']['subject'] }}</p>
    <p>{{ $details['body']['description'] }}</p>
    <p>{{ config('app.name') }}</p>
</body>
</html> --}}
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="{{ $details['body']['link'] }}"
                                                                               ...
                                                                               Tiket Code : {{ $details['body']['code'] }}</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <h5>Kerentanan : {{ $details['body']['priority'] }}</h5>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ $details['body']['subject'] }}.</p>
                                            <p>{!! $details['body']['description'] !!}</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Regards,<br>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                      ...
                                                      Please Check the link <span class="break-all"
                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; word-break: break-all;"><a
                                                                href="{{ $details['body']['link'] }}"
                                                                style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3869d4; word-break: break-all;">{{ $details['body']['link'] }}</a></span>
                                                    </p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2025 CSIRT-Padang. All rights reserved.</p>
