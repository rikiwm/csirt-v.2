    ...
    <div class="row" x-data="{ search: '' }">
        <div class="mb-2 col-md-9 ">
            <div class="mb-2 form-floating">
                <input x-model="search" wire:model.live.defer="search" type="text"
                    class="form-control form-control-sm ps-2 bg-gradient-faded-white-vertical rounded-xl"
        ...
        <div class="mb-3 col-md-3">
            <div class=" form-floating">
                <select class="form-control ps-2 pe-2 bg-gradient-faded-white rounded-xl" wire:model.live="categori_id"
                    id="cate">
                    <option value=""></option>
