            ...
            <div class="card bg-transparent shadow-none  border-0">
                <section class="image-container mt-n1 mt-lg-n10 mx-n5" id="zoomImage">
                    <div class="card card-body blur blur-rounded p-0 p-lg-1">
                        <img src="{{ asset('frontend/img/abg.png') }}" alt="Nature Image"
                            class="bg-cover border-radius-xl" loading="lazy">
                        <!-- <img src="https://media.slidesgo.com/storage/162549/responsive-images/24-cybersecurity-infographics___media_library_original_1600_900.png"
                            alt="Nature Image" class="border-radius-xl p-1" loading="lazy"> -->
                    </div>
                </section>
            </div>
        </div>
    ...
    <div class="container-fluid">
        <x-section-component :section="$section" class="text-center">
            <x-slot name="content">
                ...
                $section['value'][1]['data']['model-view'] == 'peringatan')
                <div class="row">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="mt-0 col-lg-6 ms-auto me-auto p-lg-4 mt-lg-0">
                        <div class="rotating-card-container ">
                            <div
                                class="mt-5 card card-rotate card-background card-background-mask-dark shadow-blur mt-md-0">
                                <div class="p-1 front front-background ">
                                    <div class="py-4 text-center card-body text-dark">
                                        ...
                                        <h3 class="text-black">{{ $section2['value'][1]['data']['content'] ?? null }}
                                        </h3>
                                        <p class="text-black opacity-8">
                                            {{ $section2['value'][1]['data']['sub_content'] ?? null }}
                                        </p>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="rounded-3">
                                            <defs>
                                                <pattern id="a" width="50" height="50" patternTransform="scale(3)"
                            ...
                            <div
                                ...
                                <div class="p-1 front front-background ">
                                    <div class="py-4 text-center card-body text-dark">
                                        ...
                                        <!-- <i class="my-3 text-4xl text-black material-symbols-rounded">touch_app</i> -->
                                        <h3 class="text-black">{{ $section2['value'][2]['data']['content'] ?? null }}
                                        </h3>
                                        <p class="text-black opacity-8">
                                ...
                                <div class="p-1 back back-background border-radius-xl"
                                    style="background-image: url('{{ asset('frontend/img/pattern.png') }}')">
                                    <div class="text-center card-body pt-7">
                                        <h3 class="text-dark">{{ $section2['value'][2]['data']['sub_content'] ?? null }}
                                        </h3>
                                        <p class="text-dark opacity-8">
                                            {{ $section2['value'][2]['data']['content'] ?? null }}
                                        </p>
                                        <a href="/faq" target="_blank"
                                            class="mx-auto mt-3 btn btn-white btn-sm w-50">Selengkapnya</a>
                                    </div>
