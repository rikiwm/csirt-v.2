@props(['item' => 'p'])
<nav
    class="px-2 mx-auto my-0 shadow p-1 p-lg-0 navbar navbar-expand-lg blur navbar-blur border-radius-lg z-index-fixed position-absolute my-lg-3 start-0 end-0">
    <div class="px-2 container-fluid">
        <a class="text-sm navbar-brand font-weight-bolder" href="/" rel="tooltip"
            ...
            <div class="d-flex align-items-center text-dark">
                <img class="w-8 img-fluid d-none d-lg-block" src="{{ asset('frontend/img/cslogo.png') }}"
                    alt="web-logo">
