...
<div class="container ">
    <div class="row justify-content-center">
        <div class="mx-auto my-auto text-center col-lg-12 col-10">
            <h1 class="pt-0 text-white display-1 font-weight-light ls-1 text-capitalize"
                style="font-family: 'MinePlayer', sans-serif; font-weight: 100; font-size: clamp(4rem, 2.2143rem + 5.7143vw, 6.5rem);">
