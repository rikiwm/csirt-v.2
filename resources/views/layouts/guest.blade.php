...
<body class="bg-white index-page" style=" background-image: url('frontend/img/blue.png'); background-size: contain;">
                ...
                <x-navbar>
                    <x-slot name="content">
                        ...
                        <ul class="navbar-nav navbar-nav-hover ms-auto justify-content-center">
                            <li class="my-auto nav-item ms-3 ms-lg-4">
                                <a href="/app/login"
                                    class="p-1 mt-2 mb-0 rounded btn btn-facebook ms-1 btn-icon mt-md-0 ">
