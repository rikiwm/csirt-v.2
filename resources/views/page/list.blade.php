                ...
                <div class="row">
                    <div class="text-center row justify-content-center my-sm-2">
                        <div class="col-lg-6">
                            ...
                            <h2 class="mb-0 text-dark" style="font-family: 'Wheaton', sans-serif; font-weight: 100;">
                                Terkait Lainya </h2>
                ...
                <div class="container py-2">
                    <div class="row">
                        ...
                        <div class="col-lg-6 justify-content-center d-flex flex-column">
                            <div class="card">
                                <div class="d-block blur-shadow-image">
                                    <img src="https://csirt.padang.go.id/storage/post-image/ghfG5aMIcAmz9xgO26DAXSwmPdnysN8U7Dm1lYYb.jpg"
                                        alt="img-blur-shadow-blog-2" class="img-fluid border-radius-lg" loading="lazy">
                                </div>
                            </div>
                        </div>
                        <div class="pt-3 col-lg-6 justify-content-center d-flex flex-column pl-lg-5 pt-lg-0">
                            ...
                            <h3 class="card-title">
                                <a href="" class="text-dark">Lorem ipsum dolor sit, amet consectetur adipisicing
                                    elit.</a>
                            </h3>
                            <p class="card-description">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam nostrum inventore,
                                excepturi itaque odit molestias perspiciatis mollitia rerum similique eum porro, hic
                                ipsa ullam ut? Id inventore ex suscipit illo. …
                                <a href=""
                                    class="mt-2 text-sm text-darker icon-move-right d-flex align-items-center">Read More
                                    <i class=" material-symbols-rounded ms-2">east</i>
                                </a>
                            </p>
                            <p class="author">
