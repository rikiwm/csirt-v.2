...
class SettingWebPolicy
{
    ...
    {
        return $user->can('delete_any_setting::web');
    }
    ...
    {
        return $user->can('force_delete_setting::web');
    }
    ...
    {
        return $user->can('force_delete_any_setting::web');
    }
    ...
    {
        return $user->can('restore_any_setting::web');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, SettingWeb $settingWeb): bool
    {
        return $user->can('replicate_setting::web');
    }
    ...
    {
        return $user->can('reorder_setting::web');
    }
}
